...
ALTER TABLE `tl_dms_documents` CHANGE `dk_datei` `data_file_name` varchar(100) NOT NULL default '';
ALTER TABLE `tl_dms_documents` CHANGE `dk_dateityp` `data_file_type` varchar(3) NOT NULL default '';
ALTER TABLE `tl_dms_documents` CHANGE `dk_dateigroesse` `data_file_size` int(5) NOT NULL default '0';
ALTER TABLE `tl_dms_documents` CHANGE `dk_bild` `data_file_preview` varchar(64) NOT NULL default '';
